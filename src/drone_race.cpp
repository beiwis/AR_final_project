...
DroneRace::DroneRace(ros::NodeHandle nh) : nh_(nh)
{
    ...
    if (!nh_.getParam("targets_file_path", targets_file_path_))
    {
        ...
        targets_file_path_gt = "/home/arob/catkin_ws/src/final_project/data/gates.txt";
        targets_file_path_ = "/home/arob/catkin_ws/src/final_project/data/gates_noise.txt";
    }
